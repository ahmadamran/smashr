<x-app-layout>
    <x-slot name="header"><h1 class="text-3xl font-black text-[#071a80]">Create tournament</h1></x-slot>
    <div class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('organizer.tournaments.store') }}" class="grid gap-4 rounded-lg bg-white p-6 shadow-lg md:grid-cols-2">@csrf
            ...
            <button class="rounded-md bg-[#071a80] px-4 py-3 text-sm font-black uppercase text-white md:col-span-2">Create tournament</button>
        </form>
    </div>
</x-app-layout>
