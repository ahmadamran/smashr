<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h1 class="text-3xl font-black text-brand-blue">{{ ucfirst($format) }} leaderboard</h1>
        </div>
    </x-slot>
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-lg">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-brand-ink/10">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-10 text-center text-brand-ink/60">No confirmed {{ $format }} matches yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
